...
function Header() {
  ...
  <ReactBootStrap.Navbar.Brand js-scroll-trigger href="#home">Merit Bank</ReactBootStrap.Navbar.Brand>
  ...
  <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
    ...
    <ReactBootStrap.Nav>
      <ReactBootStrap.Nav.Link js-scroll-trigger href="#benefits">Benefits</ReactBootStrap.Nav.Link>
